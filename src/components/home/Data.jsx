...
const Data = () => {
    return(
        ...
        <h1 className="home__title">Lohith Mandla
        ...
        <h3 className="home__subtitle">Python Devloper</h3>
        <p className="home__description">I'm Python full stack devloper based in Hyderabad, and I'm very passionate and dedicated to my work.</p>
